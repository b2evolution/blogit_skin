	...
	<div id="header">
		<div id="mainwrap">
			...
			<div id="topright">
	  			<div align="right">    
	  			<?php
					echo '<a href="'.$Blog->gen_blogurl().'?tempskin=_rss2"><img alt="rss" src="images/rss.gif" /></a>';
				?>
        		</div>
			...
			<img src="images/spacer.gif" alt="Free Blog Themes/Templates" width="900" height="1" />
		</div>
	</div><!-- end of header -->
